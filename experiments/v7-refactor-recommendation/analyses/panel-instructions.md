...
- [`../glossary.md`](../glossary.md) — shared V7 vocabulary (S1/S2, substrate, plants, metrics, all 13 match labels, binding rules, rounds/phases, code refs, PR/issue index). Worth a skim before starting your scoring pass — most jargon in this doc (`primary_match_specifics_outside_tolerance`, `tolerance_flag:`, panel-routing, the orphan-rec_token signal) is defined there.
- [`../results.md`](../results.md) — the experiment writeup; §4.3 is the κ-reporting destination for your scores.
- [`../rubric-modifications.md`](../rubric-modifications.md) — chronological log of rubric / manifest / scorer changes; useful if you need to understand why a given match label was introduced (e.g., the value-aware-specifics PR #90 entry explains where the 102 `primary_match_specifics_outside_tolerance` rows came from).
