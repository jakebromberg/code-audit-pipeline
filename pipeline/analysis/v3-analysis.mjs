...
//
// Reads /tmp/wxyc-audit-v3/<condition>/trial-N/output.json across C2, C3, C4
...
const PATH_PREFIX_RE = /\/Users\/[^/]+\/Developer\/WXYC\/dj-site(?:-v3-plants)?\//g;
...
function clusterMatchesPlant(cid, plant) {
  ...
  return wantKeys.includes(semanticKey(cid));
}
